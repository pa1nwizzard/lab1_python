...
table_cost = (
    table_item_1['quantity'] * table_item_1['price'] +
...
sofa_cost = (
    sofa_item_1['quantity'] * sofa_item_1['price'] +
...
chair_quantity = (
    chair_item_1['quantity'] +
    chair_item_2['quantity'] +
    chair_item_3['quantity']
)

chair_cost = (
    chair_item_1['quantity'] * chair_item_1['price'] +
